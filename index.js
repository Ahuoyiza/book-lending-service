...
6--> Romance 👩‍❤️‍👨`);
 ...
 Thanks!
       `);
                   ...
                   console.log("The catalogue you entered doesn't exist.");
               }
           } else {
       ...
       updateRentalList() {
           if ((rentalNumber <= allRentedBooks.length) && (rentalNumber > 0)) {
               ...
               console.log(`
Nothing to update. Invalid input`);
           }
       },
   };
...
Hint: You can't submit an empty field.`);
               ...
               console.log(`
Error: The catalogue you entered doesn't exist.`
               )
           }
       },
   };
...
E.g: To view collections, type 1 and press enter`);
       ...
       console.log("Oops that's not a valid input. Try Again");
   }
};
userActivity();